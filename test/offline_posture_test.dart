...
void main() {
  useAcEmission('test/offline_posture_test.dart');

  group('no network surface', () {
    acTest(
      'nothing under lib/ imports a networking library',
      <String>['ac-31'],
      () {
    ...
    acTest(
      'the main manifest declares no INTERNET permission and no backup',
      <String>['ac-36'],
      () {
    ...
    acTest(
      'data extraction rules exclude cloud backup and device transfer',
      <String>['ac-36'],
      () {
